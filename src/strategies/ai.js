...
// FIX: Use correct model name; correctly instantiate Anthropic SDK (no .default)
async function humanizeWithAnthropic(data, options = {}) {
  ...
  // FIX: SDK may export the class as default export or as named export depending on version
